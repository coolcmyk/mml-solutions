...
\begin{solution}
  ...
  well the first thing we need to consider in order to determine the dimensions of these $\frac{\partial f}{\partial \bx}$ is to look at the input dimensions of x, the product of equations and combine them \\

  \textbf{case $f_1$}: \\
  we can see that it takes $x_1$ and $x_2$ or just simply look at the notation $\quad \bx \in \R^2$, well basically it means the same thing
  ...
  \[f_2(\bx, \by) = \bx^\T \by = x_1y_1 + x_2y_2 + \dots + x_ny_n \,, \quad \bx, \by \in \R^n \]
  ...
  \[ \left[ \frac{\partial f_2}{\partial x_1}, \frac{\partial f_2}{\partial x_2}, \dots, \frac{\partial f_2}{\partial x_n} \right] = [y_1, y_2, \dots, y_n] = \by^\T \]
